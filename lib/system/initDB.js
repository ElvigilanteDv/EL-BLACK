...
function initDB(m, client) {
  ...
  settings.id ??= '120363404707199986@newsletter'
  settings.nameid ??= "'ೃ࿔AMILCARGIT Channel OFC.ೃ࿐"
  settings.type ??= 'Owner'
  settings.link ??= 'https://api-gohan.onrender.com'
  settings.banner ??= 'https://raw.githubusercontent.com/dvwilker/gohan-storage/main/1778967845826-IMG-20260516-WA0117.jpg'
  settings.icon ??= 'https://raw.githubusercontent.com/dvwilker/gohan-storage/main/1778967845826-IMG-20260516-WA0117.jpg'
  settings.currency ??= 'Coins'
  settings.namebot ??= 'Gotenks'
  settings.botname ??= 'Gotenks'  
  settings.owner ??= ''
